 ...
 * 2019-02-02T08:43:10.486-05:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "EmployeeProfileService",
                  wsdlLocation = "file:/E:/Workspace/Webservices/StubUsingCXF/src/main/resources/wsdl/EmployeeProfile.wsdl",
...
public class EmployeeProfileService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Workspace/Webservices/StubUsingCXF/src/main/resources/wsdl/EmployeeProfile.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EmployeeProfileService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/Workspace/Webservices/StubUsingCXF/src/main/resources/wsdl/EmployeeProfile.wsdl");
        }
        WSDL_LOCATION = url;
    }
