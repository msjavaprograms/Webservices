 ...
 * 2019-02-05T08:54:59.760-05:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "CustomerOrdersService",
                  wsdlLocation = "file:/E:/Workspace/Webservices/TopDownService/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl",
...
public class CustomerOrdersService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Workspace/Webservices/TopDownService/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/Workspace/Webservices/TopDownService/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
