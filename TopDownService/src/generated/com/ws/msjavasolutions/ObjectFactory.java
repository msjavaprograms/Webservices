 ...
 * generated in the com.ws.msjavasolutions package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersRequest_QNAME = new QName("http://msjavasolutions.ws.com/", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://msjavasolutions.ws.com/", "getOrdersResponse");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://msjavasolutions.ws.com/", "createOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://msjavasolutions.ws.com/", "createOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ws.msjavasolutions
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://msjavasolutions.ws.com/", name = "getOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://msjavasolutions.ws.com/", name = "getOrdersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://msjavasolutions.ws.com/", name = "createOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://msjavasolutions.ws.com/", name = "createOrdersResponse")
